<footer class="footer">
    <div class="footer__logo-box">
        <img src="../org_images/org_logo.JPG" alt="Full logo" class="footer__logo">
    </div>
    <div class="row">
        <div class="col-1-of-2">
            <div class="footer__navigation">
                <ul class="footer__list">
                    ...
                    <li class="footer__item"><a href="services.php" class="footer__link">Services</a></li>
                    <li class="footer__item"><a href="team.php" class="footer__link">Team</a></li>
                    <li class="footer__item"><a href="properties.php" class="footer__link">Properties</a></li>
